...
//#define EAP_PASSWORD "scotland2010"
...
ThingSpeak.setField(1, rdf.pack.tsdata.sensor[0]);
ThingSpeak.setField(2, rdf.pack.tsdata.sensor[1]);
ThingSpeak.setField(3, rdf.pack.tsdata.sensor[2]);
ThingSpeak.setField(4, rdf.pack.tsdata.sensor[3]);
