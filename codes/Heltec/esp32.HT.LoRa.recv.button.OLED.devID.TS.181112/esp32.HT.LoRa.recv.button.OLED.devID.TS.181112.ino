...
//char ssid[] = "smartcomputerlab";          //  your network SSID (name) 
char ssid[] = "YotaPhoneAP"; 
char pass[] = "IoT-2018"; //your network passw
...
delay(1000);     
  ...
  delay(1000);
    u8x8.clear();
    u8x8.drawString(0,1,"WiFi OK, IP:");
...
void loop() {
 ...
 Serial.print("RSSI from queue:");Serial.println(rurssi.pack.rssi);
   ...
   ThingSpeak.setField(4, (float)rurssi.pack.rssi);
