...
void loop() {
      ...
      if(!strcmp(inbuff,"7")||!strcmp(inbuff,"8")||!strcmp(inbuff,"9")||
         !strcmp(inbuff,"10")||!strcmp(inbuff,"11"))
      { Serial.print("SF set to:"); Serial.println(inbuff); sf=atoi(inbuff);
       LoRa.setSpreadingFactor(sf);dispPara();
      }
      else 
        Serial.println("wrong SF value");
        
      if(!strcmp(inbuff,"31250")||!strcmp(inbuff,"62500")||!strcmp(inbuff,"125000")||
         !strcmp(inbuff,"250000")||!strcmp(inbuff,"500000"))
      { Serial.print("SB set to:"); Serial.println(inbuff); sb=atoi(inbuff);
        LoRa.setSignalBandwidth(sb);dispPara();
      }
      else 
        Serial.println("wrong SB value");
        
      if(!strcmp(inbuff,"868")) 
        { LoRa.setFrequency(868E6);
        Serial.println("Frequency set to:868MHz");dispPara();}
      if(!strcmp(inbuff,"869"))
        { LoRa.setFrequency(869E6);
        Serial.println("Frequency set to:869MHz");dispPara();}
      if(!strcmp(inbuff,"870")) 
        { LoRa.setFrequency(870E6);
        Serial.println("Frequency set to:870MHz");dispPara();}   
      delay(3000);
}
