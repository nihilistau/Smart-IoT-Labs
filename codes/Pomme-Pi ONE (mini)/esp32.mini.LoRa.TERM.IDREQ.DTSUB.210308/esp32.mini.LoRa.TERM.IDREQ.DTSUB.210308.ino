...
void send_DTSUB(char *topic)  // send DTSUB frame - subscribe topic
{
  ...
  sdf.pack.con[0]=0x45; sdf.pack.con[1]=0x00;        
...
//      }
  ...
  if(packetSize==64)
    ...
    if(rdf.pack.con[0]==0x48 && rdf.pack.did==termID && !strncmp(rdf.pack.topic,sdf.pack.topic,24))   // received DTPUB ACK frame for this node  
      {
