...
float req_HTTP()
{
  ...
  SIM800L.println("AT+HTTPPARA=\"URL\",\"86.217.14.104:443/channels/174/fields/1/last?key=V7M6I771U8OJ2JSV\"");  /* Set parameters for HTTP session */
  delay(4000);
  ShowSerialData();
  delay(5000);
